...
{
    public class TestSummaryTests : TestbaseBase
    {
        ...
        public void TestTestSummary()
        {
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                ...
                Assert.ThrowsAsync<ErrorResponseException>(() => t_TestBaseClient.TestSummary.GetWithHttpMessagesAsync(t_ResourceGroupName, t_TestBaseAccountName, ErrorValue));

                try
                {
                    var testSummary = t_TestBaseClient.TestSummary.GetWithHttpMessagesAsync(t_ResourceGroupName, t_TestBaseAccountName, testSummaryName).GetAwaiter().GetResult();
