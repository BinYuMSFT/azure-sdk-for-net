...
namespace Microsoft.TestBase.Models
{
    ...
    /// </summary>
    public partial class PackageDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PackageDeleteHeaders class.
        /// </summary>
        public PackageDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// operation.</param>
        public PackageDeleteHeaders(string azureAsyncOperation = default(string), string location = default(string))
        {
