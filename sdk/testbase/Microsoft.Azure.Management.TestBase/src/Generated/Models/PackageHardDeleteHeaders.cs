...
namespace Microsoft.TestBase.Models
{
    ...
    /// </summary>
    public partial class PackageHardDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PackageHardDeleteHeaders class.
        /// </summary>
        public PackageHardDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// operation.</param>
        public PackageHardDeleteHeaders(string azureAsyncOperation = default(string), string location = default(string))
        {
