...
namespace Microsoft.TestBase.Models
{
    ...
    /// </summary>
    public partial class TestBaseAccountOffboardHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TestBaseAccountOffboardHeaders
        /// class.
        /// </summary>
        public TestBaseAccountOffboardHeaders()
        {
            CustomInit();
        }
        ...
        /// operation.</param>
        public TestBaseAccountOffboardHeaders(string azureAsyncOperation = default(string), string location = default(string))
        {
