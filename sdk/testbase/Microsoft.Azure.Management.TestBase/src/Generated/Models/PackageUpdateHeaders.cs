...
namespace Microsoft.TestBase.Models
{
    ...
    /// </summary>
    public partial class PackageUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PackageUpdateHeaders class.
        /// </summary>
        public PackageUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// operation.</param>
        public PackageUpdateHeaders(string azureAsyncOperation = default(string), string location = default(string))
        {
